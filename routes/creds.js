...
module.exports = function (app) {
	...
	app.get('/patients/:patient_id', function (req, res, next) {
		...
		Creds.findById(patient_id, function (err, patient) {
			if (err) return next(err);
	...
	app.post('/patients', function (req, res, next) {
		...
		validate.is_valid_patient(new_patient).then(function (error_msg) {
	...
	app.post('/patients/update', function (req, res, next) {
		...
		validate.is_valid_patient(updated_patient).then(function (error_msg) {
